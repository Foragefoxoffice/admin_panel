(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9abf5a._.js", {
                    ...
                    try {
                        ...
                        const requests = endpoints.map({
                            "CSVImporter.useEffect.fetchData.requests": (endpoint)=>fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/${endpoint}`, {
                                    ...
                                    "CSVImporter.useEffect.fetchData.requests": async (res)=>{
                                        if (res.status === 401) {
                                            handleUnauthorized();
...
_s(CSVImporter, "zaNLJV7FCEKsScHXrBbD2px5Wf4=", false, function() {
    return [
...
//# sourceMappingURL=_9abf5a._.js.map