(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_f96a97._.js", {
...
function LoginScreen() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/auth/login`, {
                method: "POST",
                headers: {
    ...
    const handleGoogleSuccess = async (credentialResponse)=>{
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/auth/google`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
_s(LoginScreen, "SxziYJeiDG1MMEe40IKGXz7ABR8=", false, function() {
    return [
...
//# sourceMappingURL=src_f96a97._.js.map