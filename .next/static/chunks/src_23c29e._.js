(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_23c29e._.js", {
            ...
            const fetchTopics = {
                "QuestionsPage.useEffect.fetchTopics": async ()=>{
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/topics?chapterId=${selectedChapter}`, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
...
_s(QuestionsPage, "9MDs6/pGVgpOyNplgDMFbumN3ps=", false, function() {
    return [
...
//# sourceMappingURL=src_23c29e._.js.map