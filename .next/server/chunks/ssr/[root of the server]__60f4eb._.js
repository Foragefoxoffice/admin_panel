...
;
;
// 1. Initialize MathJax components
...
const tex = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mathjax$2d$full$2f$js$2f$input$2f$tex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeX"]({
    ...
    macros: {
        ...
        '\\displaystyle': '\\style{display:inline-block;}{#1}'
    }
});
...
function MathJaxRenderer({ content }) {
    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!ref.current || !content) return;
        try {
            // 4. Create container and convert
            const container = adaptor.parse(content, {
                display: true
            });
            const node = html.convert(container || content, {
                display: true,
                em: 16,
                ex: 8,
                containerWidth: 80 * 16
            });
            // 5. Handle output properly
            ref.current.innerHTML = adaptor.innerHTML(node);
        } catch (err) {
            console.error('MathJax rendering error:', err);
            ref.current.innerHTML = content; // Fallback to raw content
        }
    }, [
        content
    ]);
        ...
        config: {
            loader: {
                load: [
                    ...
                    '[tex]/ams',
                    '[tex]/newcommand',
                    '[tex]/physics' // Optional for physics notation
                ],
                ready: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$react$2d$mathjax$2f$esm$2f$MathJax$2f$MathJax$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MathJax$3e$__["MathJax"].startup.defaultReady()
            },
            tex: {
                packages: {
                    '[+]': [
                ...
                tags: 'ams',
                macros: {
                    // Ensure matrix environments work even if AMS fails to load
            ...
            startup: {
                typeset: true,
                pageReady: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$react$2d$mathjax$2f$esm$2f$MathJax$2f$MathJax$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MathJax$3e$__["MathJax"].startup.defaultPageReady()
            }
        },
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__60f4eb._.js.map