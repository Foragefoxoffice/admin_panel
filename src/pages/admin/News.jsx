  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid gap-4 md:flex justify-between items-center mb-8">
        ...
        <Link to="/admin/addnews" className="btn">
          Create New Article
        </Link>
      </div>
      ...
      {newsList.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Link to="/admin/addnews" className="btn mt-4 inline-block">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex space-x-2">
                    <Link to={`/admin/news/edit/${news._id}`} className="text-blue-500 hover:text-blue-700">
                      <Edit size={18} />
                    </Link>
                    <button
