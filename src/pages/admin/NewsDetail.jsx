...
export default function NewsDetailPage({ params }) {
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <Link to="/news" className="mt-4 btn">
  ...
  if (!news) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <Link to="/admin/news" className="mt-4 btn">
          <ArrowLeft size={16} className="mr-1" /> Back to News
        </Link>
      </div>
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        <Link to="/admin/news" style={{ display: "inline-flex" }} className="btn">
          <ArrowLeft size={16} className="mr-1" /> Back to News
        </Link>
      </div>
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex space-x-2">
              <Link to={`/admin/news/edit/${params.id}`}
